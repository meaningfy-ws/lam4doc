...
def upload_rdfs(lam_properties_document: FileStorage = None, lam_classes_document: FileStorage = None,
    ...
    try:
        ...
        # return sparql_adapter.delete_graph("A_DATASET_NAME", "<http://localhost:3030/A_DATASET_NAME/data/testme1>")
        ...
        with tempfile.TemporaryDirectory() as temp_folder:
            if lam_properties_document:
                ...
                sparql_adapter.upload_file_to_graph("A_DATASET_NAME", "testgraph001", str(local_lam_properties_file))
        #
