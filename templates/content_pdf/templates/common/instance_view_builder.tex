 ...
 \BLOCK{ set select_query =
    ...
    %- call macros.render_fetch_results(content, error) 
        %- if not content.dropna(how="all").empty 
            ...
            %# \VAR{ macros.render_description_item_local_iri (content, "member", "Members", None,True) }
            %# \VAR{ macros.render_description_item_local_iri (content, "broaderConcept", "Broader Concepts", None,True) }
