...
#    And the field with id "TOC_PART_1" has CSS class SOME_CSS_CLASS_HERE
    ...
    When I navigate to the location /properties.html
    And I switch to the iframe with ID lamContent
    And I click on the element with XPath /html/body/main/div[2]/ul[4]/li
    And I click on the element with XPath /html/body/main/div[2]/ul[3]/li
    Then the field with XPath /html/body/main/div[2]/ul[4]/ul is not visible
    ...
    And I switch to the iframe with ID lamContent
    And I click on the element with XPath /html/body/main/div[2]/ul[4]/li
    And I click on the element with XPath /html/body/main/div[2]/ul[4]/ul/li[1]/a
    Then the field with XPath /html/body/main/div[2]/ul[4]/ul/li[1]/a has CSS class tocify-item active
